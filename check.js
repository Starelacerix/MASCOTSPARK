    ...
    function bootSelects() {
      ...
      populateSelect("emotion", emotions, "calm-glowy");
    ...
    const APP_CACHE_NAME = "mascot-spark-v42";
...
<section><h2>Reflection</h2><div class="reflection"></div></section>
    ...
    let selectedEmotionKey = "calm-glowy";
    ...
    function syncLessonEmotionToLab(){
      const key=document.getElementById("emotion")?.value || "calm-glowy";
    ...
    function renderEmotionCompareSelects(){
      ...
      const currentA=a.value || selectedEmotionKey, currentB=b.value || (selectedEmotionKey==="calm-glowy" ? "timidMagical" : "calm-glowy");
      a.innerHTML=options; b.innerHTML=options; a.value=emotionMap[currentA]?currentA:selectedEmotionKey; b.value=emotionMap[currentB]?currentB:"timidMagical";
    }
    function renderEmotionCompare(){
      ...
      const b=getEmotionEntry(document.getElementById("emotionCompareB")?.value || "timidMagical");
    ...
    function shadingLabFallback() {
      ...
      return {
        title: `Magical Glam Strange-Pretty Family Active — ${c.shadeStyle}`,
        summary,
        sections,
        note: styleNote
      };
    ...
    function renderShadeOutput(data) {
      ...
      if (!title || !body) return;
      title.textContent = data.title || "Magical Glam Strange-Pretty Family Active";
...
function generalLessonFallback() {
    ...
    function updateFinalBuildBadge() {
      ...
      if (badge) badge.textContent = `Mascot Spark ${APP_VERSION || "V20"} · Magical Glam Strange-Pretty Family Active · Cache ${APP_CACHE_NAME || "mascot-spark-v42"}`;
    }
