    ...
    function bootSelects() {
      ...
      populateSelect("emotion", emotions, "grumpy-cute");
    ...
    const APP_CACHE_NAME = "mascot-spark-v39";
...
<section><h2>Reflection</h2><div class="reflection"></div></section>
    ...
    let selectedEmotionKey = "grumpy-cute";
    ...
    function syncLessonEmotionToLab(){
      const key=document.getElementById("emotion")?.value || "grumpy-cute";
    ...
    function renderEmotionCompareSelects(){
      ...
      const currentA=a.value || selectedEmotionKey, currentB=b.value || (selectedEmotionKey==="grumpy-cute" ? "shy" : "grumpy-cute");
      a.innerHTML=options; b.innerHTML=options; a.value=emotionMap[currentA]?currentA:selectedEmotionKey; b.value=emotionMap[currentB]?currentB:"shy";
    }
    function renderEmotionCompare(){
      ...
      const b=getEmotionEntry(document.getElementById("emotionCompareB")?.value || "shy");
    ...
    function shadingLabFallback() {
      ...
      return {
        title: `Cute Mixed Family Active — ${c.shadeStyle}`,
        summary,
        sections,
        note: styleNote
      };
    ...
    function renderShadeOutput(data) {
      ...
      if (!title || !body) return;
      title.textContent = data.title || "Cute Mixed Family Active";
...
function generalLessonFallback() {
    ...
    function updateFinalBuildBadge() {
      ...
      if (badge) badge.textContent = `Mascot Spark ${APP_VERSION || "V20"} · Cute Mixed Family Active · Cache ${APP_CACHE_NAME || "mascot-spark-v39"}`;
    }
